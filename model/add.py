...
initial_weight_narrowing_divisor = 10.0 # Usually 10.0, turn up >1 to narrow initial weights closer to 0.0
...
results_one_bits = 5 # Only relevant for type 3
...
scanned_params = {
               ...
               "RETRIEVAL_LOW_CC": [0.60], # Should be ~0.9 usually; at 1.0 no retrieval will occur
               "RETRIEVAL_HIGH_CC": [0.61], # Should be 1.0 usually
