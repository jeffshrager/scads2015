...
scan_spec = {"settings.experiment_label": ["\"201508101051 deep scanning of STRAT_LOW x INCR_WRONG (x10)\""],
             "settings.n_problems": [250], # = 10x CONFIRMED (peak 201508100718)
             "settings.RETRIEVAL_LOW_CC": [0.8],# CONFIRMED by 201508100733 (peak)
             "settings.RETRIEVAL_HIGH_CC": [1.0],
             "settings.STRATEGY_LOW_CC": [0.7,0.75,0.8,0.85,0.9],
             ...
             "settings.INCR_WRONG": [0.25,0.5,0.75,1.0,1.25,1.5,1.75,2.0,2.25],
...
# interaction between STRAT_LOW and INCR_WRONG. Deep scanned these in
# 201508101051.
