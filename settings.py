...
scan_spec = {"settings.experiment_label": ["\"201508101125 scanning settings.DR_threshold\""],
             ...
             "settings.STRATEGY_LOW_CC": [0.75],  # SUGGESTED by 201508101051 (?)
             ...
             "settings.INCR_WRONG": [0.5],  # SUGGESTED by 201508101051 (?)
